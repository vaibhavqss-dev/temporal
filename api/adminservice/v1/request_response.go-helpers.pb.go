...
// Unmarshal an object of type GetClusterConfigRequest from the protobuf v3 wire format
func (val *GetClusterConfigRequest) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *GetClusterConfigRequest) Size() int {
	return proto.Size(val)
}

// Equal returns whether two GetClusterConfigRequest values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *GetClusterConfigRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *GetClusterConfigRequest
	switch t := that.(type) {
...
// Marshal an object of type GetClusterConfigResponse to the protobuf v3 wire format
func (val *GetClusterConfigResponse) Marshal() ([]byte, error) {
	return proto.Marshal(val)
}

// Unmarshal an object of type GetClusterConfigResponse from the protobuf v3 wire format
func (val *GetClusterConfigResponse) Unmarshal(buf []byte) error {
	return proto.Unmarshal(buf, val)
}

// Size returns the size of the object, in bytes, once serialized
func (val *GetClusterConfigResponse) Size() int {
	return proto.Size(val)
}

// Equal returns whether two GetClusterConfigResponse values are equivalent by recursively
// comparing the message's fields.
// For more information see the documentation for
// https://pkg.go.dev/google.golang.org/protobuf/proto#Equal
func (this *GetClusterConfigResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	var that1 *GetClusterConfigResponse
	switch t := that.(type) {
	case *GetClusterConfigResponse:
		that1 = t
	case GetClusterConfigResponse:
		that1 = &t
	default:
