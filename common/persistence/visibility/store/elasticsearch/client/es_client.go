...
func (c *ESClient) Search(ctx context.Context, p *SearchParametersNew) (*esapi.Response, error) {
...
func (c *ESClient) OpenScroll(ctx context.Context, p *SearchParametersNew, keepAliveInterval time.Duration) (*map[string]interface{}, error) {
	query := map[string]interface{}{
		"query": p.Query,
		"sort":  p.Sorter,
	}
...
func (c *ESClient) Scroll(ctx context.Context, scrollID string, keepAliveInterval time.Duration) (*map[string]interface{}, error) {
...
func (c *ESClient) CatIndices(ctx context.Context, target string) (*[]map[string]interface{}, error) {
...
func (c *ESClient) IndexGetSettings(ctx context.Context, indexName string) (*map[string]interface{}, error) {
